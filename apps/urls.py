...
urlpatterns = [
    ...
    path('anp/budget/add/', views.budget_add, name='budget-add'),
    path('anp/budget/view/<path:_id>/', views.budget_view, name='budget-view'),
    ...
    path('anp/budget_detail/update/<path:_id>/<str:_channel>/',
         views.budget_detail_update, name='budget-detail-update'),
    path('anp/budget_detail/delete/<path:_id>/<str:_channel>/',
         views.budget_detail_delete, name='budget-detail-delete'),
]
