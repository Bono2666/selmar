...
urlpatterns = [
    ...
    #     path('', views.under_maintain, name='under-maintain'),
    ...
    path('report/transfer/export/<str:_from_yr>/<str:_from_mo>/<str:_to_yr>/<str:_to_mo>/<str:_distributor>/',
    ...
    path('report/cl/export/<str:_from_yr>/<str:_from_mo>/<str:_to_yr>/<str:_to_mo>/<str:_distributor>/',
    ...
    path('report/proposal_claim/export/<str:_from_yr>/<str:_from_mo>/<str:_to_yr>/<str:_to_mo>/<str:_distributor>/',
    ...
    path('report/budget/monthly/export/<str:_from_yr>/<str:_from_mo>/<str:_to_yr>/<str:_to_mo>/<str:_distributor>/',
         views.report_monthly_budget_toxl, name='report-monthly-budget-toxl'),
