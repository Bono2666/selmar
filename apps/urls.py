...
urlpatterns = [
    ...
    path('cl/add/<str:_area>/<str:_channel>/<str:_distributor>/',
         views.cl_add, name='cl-add'),
    path('cl/view/<str:_tab>/<path:_id>/',
         views.cl_view, name='cl-view'),
    path('cl/delete/<str:_tab>/<path:_id>/',
         views.cl_delete, name='cl-delete'),
    path('cl_detail/delete/<str:_tab>/<path:_id>/<str:_claim>/',
    ...
    path('matrix/cl/', views.cl_matrix_index,
         name='cl-matrix-index'),
    path('matrix/cl/view/<str:_id>/<str:_channel>/',
         views.cl_matrix_view, name='cl-matrix-view'),
    path('matrix/cl/update/<str:_id>/<str:_channel>/<str:_approver>/',
         views.cl_matrix_update, name='cl-matrix-update'),
    path('matrix/cl/delete/<str:_id>/<str:_channel>/<str:_arg>/',
